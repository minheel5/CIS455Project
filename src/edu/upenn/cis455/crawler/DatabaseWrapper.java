...
public class DatabaseWrapper {
	...
	public boolean addDocument(Document doc) throws Exception {
		return ((documents.put(null, stringToDbEntry(doc.getUrl()), docToDBEntry(doc))).equals(OperationStatus.SUCCESS));
	}
	...
	public Document getDocument(String url) {
		...
		OperationStatus status = documents.get(null, stringToDbEntry(url), data, LockMode.DEFAULT);
